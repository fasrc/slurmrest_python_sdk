...
class TestV0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer:
        """Test V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer`
        """
        model = V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer()
        if include_optional:
    ...
    def testV0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer(self):
        """Test V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer"""
