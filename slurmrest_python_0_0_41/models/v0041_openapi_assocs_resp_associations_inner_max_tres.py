...
class V0041OpenapiAssocsRespAssociationsInnerMaxTres(BaseModel):
    ...
    total: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="GrpTRES")
    __properties: ClassVar[List[str]] = ["group", "minutes", "per", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group": V0041OpenapiAssocsRespAssociationsInnerMaxTresGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            "minutes": V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutes.from_dict(obj["minutes"]) if obj.get("minutes") is not None else None,
            "per": V0041OpenapiAssocsRespAssociationsInnerMaxTresPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
