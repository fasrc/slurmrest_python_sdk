...
class V0041OpenapiAssocsResp(BaseModel):
    ...
    """ # noqa: E501
    associations: List[V0041OpenapiAssocsRespAssociationsInner] = Field(description="associations")
    ...
    __properties: ClassVar[List[str]] = ["associations", "errors", "meta", "warnings"]
