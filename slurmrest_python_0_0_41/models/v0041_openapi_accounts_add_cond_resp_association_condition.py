...
class V0041OpenapiAccountsAddCondRespAssociationCondition(BaseModel):
    ...
    association: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociation] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "association": V0041OpenapiAccountsAddCondRespAssociationConditionAssociation.from_dict(obj["association"]) if obj.get("association") is not None else None,
