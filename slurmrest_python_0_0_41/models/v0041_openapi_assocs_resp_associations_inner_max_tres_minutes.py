...
class V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutes(BaseModel):
    ...
    total: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESMinsPerJob")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "per": V0041OpenapiAssocsRespAssociationsInnerMaxTresMinutesPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
