...
class V0041OpenapiAccountsAddCondRespAssociationConditionAssociation(BaseModel):
    ...
    grpjobs: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpjobs] = None
    grpjobsaccrue: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpjobsaccrue] = None
    grpsubmitjobs: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpsubmitjobs] = None
    grptres: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Maximum number of TRES able to be allocated by running jobs in this association and its children")
    grptresmins: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Total number of TRES minutes that can possibly be used by past, present and future jobs in this association and its children")
    grptresrunmins: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Maximum number of TRES minutes able to be allocated by running jobs in this association and its children")
    grpwall: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpwall] = None
    maxjobs: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxjobs] = None
    maxjobsaccrue: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxjobsaccrue] = None
    maxsubmitjobs: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxsubmitjobs] = None
    maxtresminsperjob: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Maximum number of TRES minutes each job is able to use in this association")
    maxtresperjob: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Maximum number of TRES each job is able to use in this association")
    maxtrespernode: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Maximum number of TRES each node is able to use")
    maxtresrunmins: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Maximum number of TRES minutes able to be allocated by running jobs in this association")
    maxwalldurationperjob: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxwalldurationperjob] = None
    minpriothresh: Optional[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMinpriothresh] = None
    ...
    __properties: ClassVar[List[str]] = ["comment", "defaultqos", "fairshare", "grpjobs", "grpjobsaccrue", "grpsubmitjobs", "grptres", "grptresmins", "grptresrunmins", "grpwall", "maxjobs", "maxjobsaccrue", "maxsubmitjobs", "maxtresminsperjob", "maxtresperjob", "maxtrespernode", "maxtresrunmins", "maxwalldurationperjob", "minpriothresh", "parent", "priority", "qoslevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "grpjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpjobs.from_dict(obj["grpjobs"]) if obj.get("grpjobs") is not None else None,
            "grpjobsaccrue": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpjobsaccrue.from_dict(obj["grpjobsaccrue"]) if obj.get("grpjobsaccrue") is not None else None,
            "grpsubmitjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpsubmitjobs.from_dict(obj["grpsubmitjobs"]) if obj.get("grpsubmitjobs") is not None else None,
            "grptres": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["grptres"]] if obj.get("grptres") is not None else None,
            "grptresmins": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["grptresmins"]] if obj.get("grptresmins") is not None else None,
            "grptresrunmins": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["grptresrunmins"]] if obj.get("grptresrunmins") is not None else None,
            "grpwall": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrpwall.from_dict(obj["grpwall"]) if obj.get("grpwall") is not None else None,
            "maxjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxjobs.from_dict(obj["maxjobs"]) if obj.get("maxjobs") is not None else None,
            "maxjobsaccrue": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxjobsaccrue.from_dict(obj["maxjobsaccrue"]) if obj.get("maxjobsaccrue") is not None else None,
            "maxsubmitjobs": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxsubmitjobs.from_dict(obj["maxsubmitjobs"]) if obj.get("maxsubmitjobs") is not None else None,
            "maxtresminsperjob": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["maxtresminsperjob"]] if obj.get("maxtresminsperjob") is not None else None,
            "maxtresperjob": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["maxtresperjob"]] if obj.get("maxtresperjob") is not None else None,
            "maxtrespernode": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["maxtrespernode"]] if obj.get("maxtrespernode") is not None else None,
            "maxtresrunmins": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["maxtresrunmins"]] if obj.get("maxtresrunmins") is not None else None,
            "maxwalldurationperjob": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMaxwalldurationperjob.from_dict(obj["maxwalldurationperjob"]) if obj.get("maxwalldurationperjob") is not None else None,
            "minpriothresh": V0041OpenapiAccountsAddCondRespAssociationConditionAssociationMinpriothresh.from_dict(obj["minpriothresh"]) if obj.get("minpriothresh") is not None else None,
