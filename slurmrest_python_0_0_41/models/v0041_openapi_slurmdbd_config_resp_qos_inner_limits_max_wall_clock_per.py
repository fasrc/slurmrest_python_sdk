...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxWallClockPer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["job", "qos"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "job": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerWallClock.from_dict(obj["job"]) if obj.get("job") is not None else None,
            "qos": V0041OpenapiAssocsRespAssociationsInnerMaxPerAccountWallClock.from_dict(obj["qos"]) if obj.get("qos") is not None else None
        })
        return _obj
