...
class V0041OpenapiSlurmdbdJobsRespJobsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account", "allocation_nodes", "array", "association", "block", "cluster", "comment", "constraints", "container", "derived_exit_code", "exit_code", "extra", "failed_node", "flags", "group", "het", "hold", "job_id", "kill_request_user", "licenses", "mcs", "name", "nodes", "partition", "priority", "qos", "required", "reservation", "script", "state", "stderr", "stderr_expanded", "stdin", "stdin_expanded", "stdout", "stdout_expanded", "steps", "submit_line", "time", "tres", "used_gres", "user", "wckey", "working_directory"]
