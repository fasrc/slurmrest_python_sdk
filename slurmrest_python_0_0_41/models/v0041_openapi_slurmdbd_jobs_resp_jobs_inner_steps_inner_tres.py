...
class V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTres(BaseModel):
    ...
    """ # noqa: E501
    allocated: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Trackable resources allocated to the step")
    ...
    __properties: ClassVar[List[str]] = ["allocated", "consumed", "requested"]
