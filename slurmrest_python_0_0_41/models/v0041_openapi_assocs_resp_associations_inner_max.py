...
class V0041OpenapiAssocsRespAssociationsInnerMax(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": V0041OpenapiAssocsRespAssociationsInnerMaxJobs.from_dict(obj["jobs"]) if obj.get("jobs") is not None else None,
            "per": V0041OpenapiAssocsRespAssociationsInnerMaxPer.from_dict(obj["per"]) if obj.get("per") is not None else None,
            "tres": V0041OpenapiAssocsRespAssociationsInnerMaxTres.from_dict(obj["tres"]) if obj.get("tres") is not None else None
        })
        return _obj
