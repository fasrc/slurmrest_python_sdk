...
class V0041OpenapiAssocsRespAssociationsInnerAccountingInner(BaseModel):
    ...
    """ # noqa: E501
    tres: Optional[V0041OpenapiAssocsRespAssociationsInnerAccountingInnerTRES] = Field(default=None, alias="TRES")
    allocated: Optional[V0041OpenapiAssocsRespAssociationsInnerAccountingInnerAllocated] = None
    ...
    __properties: ClassVar[List[str]] = ["TRES", "allocated", "id", "start"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "TRES": V0041OpenapiAssocsRespAssociationsInnerAccountingInnerTRES.from_dict(obj["TRES"]) if obj.get("TRES") is not None else None,
            "allocated": V0041OpenapiAssocsRespAssociationsInnerAccountingInnerAllocated.from_dict(obj["allocated"]) if obj.get("allocated") is not None else None,
            "id": obj.get("id"),
            "start": obj.get("start")
        })
        return _obj
