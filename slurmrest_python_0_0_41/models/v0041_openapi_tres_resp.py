...
class V0041OpenapiTresResp(BaseModel):
    ...
    """ # noqa: E501
    tres: List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner] = Field(description="TRES", alias="TRES")
    ...
    __properties: ClassVar[List[str]] = ["TRES", "errors", "meta", "warnings"]
