...
class V0041OpenapiSlurmdbdConfigRespUsersInner(BaseModel):
    ...
    associations: Optional[List[V0041OpenapiAccountsRespAccountsInnerAssociationsInner]] = Field(default=None, description="Associations created for this user")
    coordinators: Optional[List[V0041OpenapiAccountsRespAccountsInnerCoordinatorsInner]] = Field(default=None, description="Accounts this user is a coordinator for")
