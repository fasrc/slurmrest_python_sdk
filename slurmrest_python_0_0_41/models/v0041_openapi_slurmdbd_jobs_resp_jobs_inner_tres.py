...
class V0041OpenapiSlurmdbdJobsRespJobsInnerTres(BaseModel):
    ...
    """ # noqa: E501
    allocated: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Trackable resources allocated to the job")
    requested: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="Trackable resources requested by job")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allocated": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["allocated"]] if obj.get("allocated") is not None else None,
            "requested": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["requested"]] if obj.get("requested") is not None else None
        })
        return _obj
