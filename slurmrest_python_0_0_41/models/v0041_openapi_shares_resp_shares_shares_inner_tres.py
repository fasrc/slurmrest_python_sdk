...
class V0041OpenapiSharesRespSharesSharesInnerTres(BaseModel):
    ...
    """ # noqa: E501
    group_minutes: Optional[List[V0041OpenapiSharesRespSharesSharesInnerTresGroupMinutesInner]] = Field(default=None, description="TRES-minute limit")
    run_seconds: Optional[List[V0041OpenapiSharesRespSharesSharesInnerTresGroupMinutesInner]] = Field(default=None, description="Currently running tres-secs = grp_used_tres_run_secs")
    ...
    __properties: ClassVar[List[str]] = ["group_minutes", "run_seconds", "usage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "group_minutes": [V0041OpenapiSharesRespSharesSharesInnerTresGroupMinutesInner.from_dict(_item) for _item in obj["group_minutes"]] if obj.get("group_minutes") is not None else None,
            "run_seconds": [V0041OpenapiSharesRespSharesSharesInnerTresGroupMinutesInner.from_dict(_item) for _item in obj["run_seconds"]] if obj.get("run_seconds") is not None else None,
