...
class V0041OpenapiAssocsRespAssociationsInnerMaxJobsPer(BaseModel):
    ...
    submitted: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerSubmitted] = None
    wall_clock: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerWallClock] = None
    __properties: ClassVar[List[str]] = ["accruing", "count", "submitted", "wall_clock"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accruing": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerAccruing.from_dict(obj["accruing"]) if obj.get("accruing") is not None else None,
            "count": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerCount.from_dict(obj["count"]) if obj.get("count") is not None else None,
            "submitted": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerSubmitted.from_dict(obj["submitted"]) if obj.get("submitted") is not None else None,
            "wall_clock": V0041OpenapiAssocsRespAssociationsInnerMaxJobsPerWallClock.from_dict(obj["wall_clock"]) if obj.get("wall_clock") is not None else None
        })
        return _obj
