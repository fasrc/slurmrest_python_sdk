...
class V0041OpenapiPartitionRespPartitionsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accounts", "alternate", "cluster", "cpus", "defaults", "grace_time", "groups", "maximums", "minimums", "name", "node_sets", "nodes", "partition", "priority", "qos", "select_type", "suspend_time", "timeouts", "tres"]
