...
class V0041OpenapiJobInfoRespJobsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account", "accrue_time", "admin_comment", "allocating_node", "array_job_id", "array_max_tasks", "array_task_id", "array_task_string", "association_id", "batch_features", "batch_flag", "batch_host", "billable_tres", "burst_buffer", "burst_buffer_state", "cluster", "cluster_features", "command", "comment", "container", "container_id", "contiguous", "core_spec", "cores_per_socket", "cpu_frequency_governor", "cpu_frequency_maximum", "cpu_frequency_minimum", "cpus", "cpus_per_task", "cpus_per_tres", "cron", "current_working_directory", "deadline", "delay_boot", "dependency", "derived_exit_code", "eligible_time", "end_time", "excluded_nodes", "exclusive", "exit_code", "extra", "failed_node", "features", "federation_origin", "federation_siblings_active", "federation_siblings_viable", "flags", "gres_detail", "group_id", "group_name", "het_job_id", "het_job_id_set", "het_job_offset", "hold", "job_id", "job_resources", "job_size_str", "job_state", "last_sched_evaluation", "licenses", "mail_type", "mail_user", "max_cpus", "max_nodes", "maximum_switch_wait_time", "mcs_label", "memory_per_cpu", "memory_per_node", "memory_per_tres", "minimum_cpus_per_node", "minimum_switches", "minimum_tmp_disk_per_node", "name", "network", "nice", "node_count", "nodes", "oversubscribe", "partition", "power", "pre_sus_time", "preempt_time", "preemptable_time", "prefer", "priority", "profile", "qos", "reboot", "requeue", "required_nodes", "resize_time", "restart_cnt", "resv_name", "scheduled_nodes", "selinux_context", "shared", "show_flags", "sockets_per_board", "sockets_per_node", "standard_error", "standard_input", "standard_output", "start_time", "state_description", "state_reason", "submit_time", "suspend_time", "system_comment", "tasks", "tasks_per_board", "tasks_per_core", "tasks_per_node", "tasks_per_socket", "tasks_per_tres", "thread_spec", "threads_per_core", "time_limit", "time_minimum", "tres_alloc_str", "tres_bind", "tres_freq", "tres_per_job", "tres_per_node", "tres_per_socket", "tres_per_task", "tres_req_str", "user_id", "user_name", "wckey"]
