...
class V0041OpenapiSharesRespSharesSharesInnerTresGroupMinutesInner(BaseModel):
    """
    ...
    value: Optional[V0041OpenapiSharesRespSharesSharesInnerTresGroupMinutesInnerValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "value": V0041OpenapiSharesRespSharesSharesInnerTresGroupMinutesInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
