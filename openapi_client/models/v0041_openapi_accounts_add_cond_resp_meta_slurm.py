...
class V0041OpenapiAccountsAddCondRespMetaSlurm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cluster", "release", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "version": V0041OpenapiAccountsAddCondRespMetaSlurmVersion.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
        return _obj
