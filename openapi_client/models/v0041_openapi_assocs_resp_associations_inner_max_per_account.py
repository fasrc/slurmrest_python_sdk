...
class V0041OpenapiAssocsRespAssociationsInnerMaxPerAccount(BaseModel):
    ...
    """ # noqa: E501
    wall_clock: Optional[V0041OpenapiAssocsRespAssociationsInnerMaxPerAccountWallClock] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "wall_clock": V0041OpenapiAssocsRespAssociationsInnerMaxPerAccountWallClock.from_dict(obj["wall_clock"]) if obj.get("wall_clock") is not None else None
        })
        return _obj
