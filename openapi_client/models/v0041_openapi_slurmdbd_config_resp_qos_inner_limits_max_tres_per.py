...
class V0041OpenapiSlurmdbdConfigRespQosInnerLimitsMaxTresPer(BaseModel):
    ...
    """ # noqa: E501
    account: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESPerAccount")
    job: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESPerJob")
    node: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESPerNode")
    user: Optional[List[V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner]] = Field(default=None, description="MaxTRESPerUser")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "node": [V0041OpenapiAccountsAddCondRespAssociationConditionAssociationGrptresInner.from_dict(_item) for _item in obj["node"]] if obj.get("node") is not None else None,
