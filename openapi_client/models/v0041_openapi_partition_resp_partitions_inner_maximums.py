...
class V0041OpenapiPartitionRespPartitionsInnerMaximums(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cpus_per_node", "cpus_per_socket", "memory_per_cpu", "nodes", "over_time_limit", "oversubscribe", "partition_memory_per_cpu", "partition_memory_per_node", "shares", "time"]
